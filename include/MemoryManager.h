...
public:
    ...
    // bool request_resource_with_ignorance(int process_id, ResourceType type, size_t amount) {

    //     if (total_resources[type] >= amount) {
    ...
    //                   << " without deadlock check\n";
    //         return true;
    //     }
        
        
    //     cerr << "Resource allocation failed for Process " 
    //               << process_id << endl;
    //     return false;
    // }
